...
const User = mongoose.model('User', mySchema);
            ...
            va a recibir como parámetro mySchema ---> el mySchema sería como la estructura de la collection (collection sería la tabla en la BD SQL). Sería como cuando definimos los nombres de las columnas y los valores que reciben cada una 
            */ 
