...
/* 
Antes hacíamos así el port. Pero ahora lo hacemos con varaibles de entorno (osea que vienen de el archivo .env)
const port = 3000; 
*/
...
app.use( async (req, res, next) => {
    ...
    const body = req.body; // de esta manera obtengo el contenido del request para poder despés hacer las validaciones que quiera  
    console.log(body);
    next();
})
